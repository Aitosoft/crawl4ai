...
| Test Name  | Result  |
| --- | --- |
| User Agent (Old)  | Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 Chrome/116.0.0.0 Safari/537.36  |
...
#  [Fingerprint Scanner](https://github.com/antoinevastel/fpscanner) tests
| PHANTOM_UA  | ok  |
```
{
     "userAgent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 Chrome/116.0.0.0 Safari/537.36"
}
```
 |
| --- | --- | --- |
...
| navigator.cookieEnabled  |  true   |
| navigator.userAgent  |  Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 Chrome/116.0.0.0 Safari/537.36   |
...
Level: 1  |
| Canvas1  | Hash: 1078822475  |
| Canvas2  | Hash: 1078822475  |
| Canvas3 (iframe sandbox)  |  Hash: 1078822475  |
| Canvas4 (iframe sandbox)  |  Hash: 1078822475  |
| Canvas5 (iframe)  |  Hash: 1078822475  |
# Fp-collect info
...
```
{
     ...
     "videoCard": "Not supported;;;Not supported",
     "multimediaDevices": {
          "speakers": 0,
          "micros": 0,
          "webcams": 0
...
![](https://intoli.com/nonexistent-image.png)
