...
| Test Name  | Result  |  
| --- | --- |  
| User Agent (Old)  | Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/133.0.0.0 Safari/537.36  |  
...
```
{
     ...
     "navigatorPrototype": [
          ...
          "vendor~~~() => opts.navigator_vendor || \"Google Inc.\"",
