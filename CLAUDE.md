...
pytest test-aitosoft/            # ALL offline suites, 283 tests, ~240 s — no server, no customer site
pytest test-aitosoft/ --ignore=test-aitosoft/test_fixture_origin.py  # pure-function subset, 229 tests, ~15 s
