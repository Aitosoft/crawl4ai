...
async def lifespan(_: FastAPI):
    ...
    # Aitosoft: close the static-mode httpx client and the patchright
    # fallback singleton if they were used.
    try:
    ...
    try:
        ...
        await close_patchright_crawler()
    except Exception as e:
        logger.error(f"Patchright crawler cleanup failed: {e}")
